        ...
        match provider:
            ...
            case "azure_openai":
                ...
                if azure_config.use_azure_ad:
                    logger.info(
                        "Creating Azure OpenAI LLM client with Azure AD authentication"
                    )
            ...
            case "gemini":
                if not HAS_GEMINI:
                    raise ValueError(
                        "Gemini client not available in current graphiti-core version"
                    )
            ...
            case "groq":
                if not HAS_GROQ:
                    raise ValueError(
                        "Groq client not available in current graphiti-core version"
                    )
